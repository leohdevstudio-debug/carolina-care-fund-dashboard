...
import { updateAdminBudget } from "@/services/admin/budgets";
...
export async function PATCH(
  ...
  try {
    ...
    return Response.json(await updateAdminBudget(budgetId, input));
  } catch (error) {
    return errorResponse(error, "Unable to update budget");
  }
}
